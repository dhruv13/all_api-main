...
class dio12 extends StatefulWidget {
  const dio12({Key? key}) : super(key: key);

  @override
  State<dio12> createState() => _dio12State();
}

class _dio12State extends State<dio12> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Dummy Users dio"),
      ),
      body: status
          ? ListView.builder(
              shrinkWrap: true,
